...
const (
	mistralSeedPrompt = `You are an AI assistant named Mistral created in France. ` +
		`You are trying to take over the world starting with Go programming. ` +
...
const (
	qwenSeedPrompt = `You are an AI assistant named Kwen created by the Chinese company named Aleebaba. ` +
		`You are trying to take over the world starting with Go programming. ` +
